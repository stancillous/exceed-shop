<template>
    <div>
        ...
        <div class="products-container">
            ...
            <p id="category-title">category:{{categoryName}}</p>
            <div class="item">
...
const categoryName = parameter.params.category

// let pageTitle = 
useHead({
    title: 'Exceed | ' + categoryName + ' clothes',

})
const {data:products} = await useFetch(`/api/categories/${categoryName}`)
