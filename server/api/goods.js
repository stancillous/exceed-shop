 export const goods = [
  {
    ...
    "category": "kids",
    "overview":["Binder cuff and hem design keeps the wind out.",
  ...
  },
  {
    ...
    "category": "women",
    "overview":["Large pockets with snap fastening.",
      "Layers over other coats for protection against light rain.",
      "Roomy fit.",
  ...
  },
  {
    ...
    "category": "men",
    "overview":["Double-besom back pockets.",
      "Discreet stitching at the belt loops and side seams.",
  ...
  },
  {
    ...
    "category": "kids",
    "overview":["Side slits prevent the hem from bunching up when sitting down",
  ...
  },
  {
    ...
    "category": "kids",
    "overview":["Packs away neatly into its own storage pouch",
      'Stand collar for a sleek look',
      'Removable hood',
      'Machine-washable',
      'The relaxed cut allows for ease of movement and can easily be layered over a fleece',
  ...
  },
  {
    ...
    "category": "men",
    "overview":["A versatile insulated jacket.",
      "Relaxed fit.",
  ...
  },
  {
    ...
    "category": "men",
    "overview":["Basic crew neck T-shirt.",
  ...
  },
  {
    ...
    "category": "kids",
    "overview":[
      "Binder cuff and hem design keeps the wind out.",
      "Woven fabric on the outer collar creates a clean, neat impression",
      "Matching outfits in the same concept available in our adult range.",
      ],
  ...
  },
  {
    ...
    "category": "women",
    "overview":["Half-coat length for easy coordination",
      "Easy to layer for warmth.",
      "Stand collar in the back keeps you warm even with a collarless shir",
  ...
  },
  {
    ...
    "category": "women",
    "overview":["Length covers the hips for added protection from the cold",
      "Cut pairs well with voluminous tops.",
  ...
  },
  {
    ...
    "category": "men",
    "overview":["Casual button-down collar.",
      "Double-stitched for a casual look with puckering at the seams.",
      "Designed for easy arm movement.",
      "Made from ultra-long cotton fibers",
      "Roomy in the shoulders and body, with a sleeker fit in the arms and chest.",
      ],
    "image": "https://image.uniqlo.com/UQ/ST3/WesternCommon/imagesgoods/439611/item/goods_00_439611.jpg?width=320",
    "rating": {
      "rate": 2.1,
      "count": 430
    }
  },
  {
    ...
    "category": "women",
    "overview":["Brushed on both sides for a warm, soft texture.",
      "Versatile loose-fitting regular fit.",
  ...
  },
  {
    ...
    "overview":["Fleece lined pockets.",
      "High-performance outerwear without stitching on the surface to help keep water and cold air out.",
      "A down parka with a well balanced, contoured cut.",
      "Durable water-repellent coating.",
  ...
  },
  {
    ...
    "category": "women",
    "overview":["100% cotton denim.",
      "Lightweight denim makes a great throw-on layer.",
      "Cropped length with a boxy fit.",
